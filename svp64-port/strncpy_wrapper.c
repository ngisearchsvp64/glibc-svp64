/* Copyright (C) 1991-2018 Free Software Foundation, Inc.
   ...
   adaptation to strncpy suggested by Dick Karpinski (dick@cca.ucsf.edu),
...
#undef __strncpy_svp64
#ifdef _LIBC
# undef strncpy_svp64
#endif

#ifndef weak_alias
# define __strncpy_svp64 strncpy_svp64
#endif

#ifndef STRNCPY_SVP64
# define STRNCPY_SVP64 __strncpy_svp64
#endif
...
const char *strncpy_svp64_filename = "./bin/strncpy_svp64.bin";

/* Search no more than N bytes of S for C.  */
char*
STRNCPY_SVP64 (const char *s, int c, size_t n)
{
    printf("strncpy_svp64 called: s: %p, c: %02x(%c), n: %ld\n", s, (uint8_t)c, c, n);
    ...
    state->binary = PyBytes_FromStringAndSize(strncpy_svp64_filename, strlen(strncpy_svp64_filename));
...
#ifdef weak_alias
weak_alias (__strncpy_svp64, strncpy_svp64)
#endif
libc_hidden_builtin_def (strncpy_svp64)
