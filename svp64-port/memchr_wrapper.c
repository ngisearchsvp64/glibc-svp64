...
#undef __memchr_svp64
#ifdef _LIBC
# undef memchr_svp64
#endif

#ifndef weak_alias
# define __memchr_svp64 memchr_svp64
#endif

#ifndef MEMCHR_SVP64
# define MEMCHR_SVP64 __memchr_svp64
#endif
...
const char *memchr_svp64_filename = "./bin/memchr_svp64.bin";
...
MEMCHR_SVP64 (const char *s, int c, size_t n)
{
    ...
    state->binary = PyBytes_FromStringAndSize(memchr_svp64_filename, strlen(memchr_svp64_filename));
    ...
    PyList_SetItem(state->initial_regs, 4, n_svp64);
...
#endif
libc_hidden_builtin_def (memchr_svp64)
