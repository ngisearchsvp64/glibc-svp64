/* Copyright (C) 1991-2018 Free Software Foundation, Inc.
   ...
   adaptation to strcmp suggested by Dick Karpinski (dick@cca.ucsf.edu),
...
#undef __strcmp_svp64
#ifdef _LIBC
# undef strcmp_svp64
#endif

#ifndef weak_alias
# define __strcmp_svp64 strcmp_svp64
#endif

#ifndef STRCMP_SVP64
# define STRCMP_SVP64 __strcmp_svp64
#endif
...
const char *strcmp_svp64_filename = "./bin/strcmp_svp64.bin";

/* Search no more than N bytes of S for C.  */
char*
STRCMP_SVP64 (const char *s, int c, size_t n)
{
    printf("strcmp_svp64 called: s: %p, c: %02x(%c), n: %ld\n", s, (uint8_t)c, c, n);
    ...
    state->binary = PyBytes_FromStringAndSize(strcmp_svp64_filename, strlen(strcmp_svp64_filename));
...
#ifdef weak_alias
weak_alias (__strcmp_svp64, strcmp_svp64)
#endif
libc_hidden_builtin_def (strcmp_svp64)
