/* Copyright (C) 1991-2018 Free Software Foundation, Inc.
   ...
   adaptation to strcat suggested by Dick Karpinski (dick@cca.ucsf.edu),
...
#undef __strcat_svp64
#ifdef _LIBC
# undef strcat_svp64
#endif

#ifndef weak_alias
# define __strcat_svp64 strcat_svp64
#endif

#ifndef STRCAT_SVP64
# define STRCAT_SVP64 __strcat_svp64
#endif
...
const char *strcat_svp64_filename = "./bin/strcat_svp64.bin";

/* Search no more than N bytes of S for C.  */
char*
STRCAT_SVP64 (const char *s, int c, size_t n)
{
    printf("strcat_svp64 called: s: %p, c: %02x(%c), n: %ld\n", s, (uint8_t)c, c, n);
    ...
    state->binary = PyBytes_FromStringAndSize(strcat_svp64_filename, strlen(strcat_svp64_filename));
...
#ifdef weak_alias
weak_alias (__strcat_svp64, strcat_svp64)
#endif
libc_hidden_builtin_def (strcat_svp64)
